...
While the canonical example of a vector space is the space of real n-dimensional vectors $\mathbb{R}^N$, this definition is general enough to define vector spaces of other mathematical objects. \todo{Example using vector space of functions}.
...
\begin{description}
	\item[Linearity in First Argument] $\innerProd{a \otimes \mathbf{u}, \mathbf{v}} = a \cdot \innerProd{\mathbf{u}, \mathbf{v}}$ and $\innerProd{\mathbf{u} \oplus \mathbf{v}, \mathbf{w}} = \innerProd{\mathbf{u}, \mathbf{w}} + \innerProd{\mathbf{v}, \mathbf{w}}$.
    \item[Positive-definiteness] $\innerProd{v, w}
\end{description}
\end{definition}
