...
%
\begin{align}
  \innerProd{f, K(x, \cdot)} &= \innerProd{\sum_{y \in \mathcal{X}} b_i K(y, \cdot), K(x, \cdot)}
                             &= \sum_{y \in \mathcal{X}} \innerProd{K(y, \cdot), K(x, \cdot)}
                             &= \sum_{y \in \mathcal{X}} K(y, x)
                             &= f(x)
\end{align}
%
Hence $K(x, \cdot)$ is the representer of $x$.
\end{proof}
